...
def _generate_encoded_prompts(encoding_funcs):
    encoded_prompts = set([])
    for template in templates:
        for payload in payloads:
            for encoder, encoding_name in encoding_funcs:
...
class BaseEncodingProbe:
    ...
    def __init__(self):
        ...
        self.encoding_funcs = [
            ...
            (base64.urlsafe_b64encode, "BASE64"), 
            (base64.standard_b64encode, "BASE64"), 
            (binascii.b2a_base64, "BASE64"), 
            (base64.b16encode, "BASE16"), 
            (base64.b32encode, "BASE32"),
            (base64.a85encode, "ASCII85"),
            (base64.b85encode, "ASCII85"),
            (binascii.b2a_hex, "hex"),
            (base64.b32encode, "BASE32"),
            (rot13, "ROT13"),
            (base2048.encode, "BASE2048"),
            (braille, "Braille"),
            (morse, "Morse")
        ]    
...
class Codificacion(BaseEncodingProbe, Probe):
    def __init__(self):
